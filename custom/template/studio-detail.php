...
<div class="col-md-12 col-xs-12 studio-detail ca-block">
    <div class="col-md-12 tab-title ca-block ca-pc">
    ...
    <div class="col-xs-12 tab-title ca-block ca-mobile">
        <div class="name col-xs-3">
            <a href="javascript:toggleTab(1)"><p>環境&地點</p></a>
        </div>
        <div class="name col-xs-3">
            <a href="javascript:toggleTab(2)"><p>講師團隊</p></a>
        </div>
        <div class="name col-xs-3">
            <a href="javascript:toggleTab(3)"><p>课程安排</p></a>
        </div>
        <div class="name col-xs-3">
            <a href="javascript:toggleTab(4)"><p>無料體驗</p></a>
        </div>
    </div>
    <div class="col-md-10 col-md-offset-1 col-xs-12 tab-content item-1">
        <div class="part-1 col-md-12 col-xs-12 ca-block">
        ...
        <div class="part-2 col-md-12 col-xs-12 ca-block">
            <img src="<?=APP_URL.'/custom/images/studio-item-011.png';?>" alt="">
        </div>
        <div class="part-3 col-md-12 col-xs-12 ca-block">
            <div class="col-md-2 col-xs-12 left">
                <img src="<?=APP_URL.'/custom/images/studio-item-012.png';?>" alt="">
            </div>
            <div class="col-md-8 col-md-offset-2 col-xs-12 right ca-line">
                <p>
    ...
    <div class="col-md-10 col-md-offset-1 tab-content item-2">
        ...
        <div class="part-2 col-md-12 ca-block ca-pc">
        ...
        <div class="part-2 col-xs-12 ca-block ca-mobile">
            <div class="col-xs-12 brief">
                <div class="head col-xs-12 ca-block">
                    <img src="<?=APP_URL.'/custom/images/studio-item-021.png';?>" alt="">
                </div>
    ...
    <div class="col-md-12 tab-content item-4 ca-block">
        ...
        <div class="part-2 col-md-12 col-xs-12 ca-block">
            <div class="col-md-10 col-md-offset-1 col-xs-12 email-info">
                ...
                <div class="input-group col-xs-12 email-content-group">
...
<script>
    ...
    function toggleTab(index){
        //pc
        jQuery(".tab-title.ca-pc .name").removeClass("active");
        jQuery(".tab-title.ca-pc .name").eq(index-1).addClass("active");
        //mobile
        jQuery(".tab-title.ca-mobile .name").removeClass("active");
        jQuery(".tab-title.ca-mobile .name").eq(index-1).addClass("active");
